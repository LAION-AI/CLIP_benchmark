...
def build_dataset(dataset_name, root="root", transform=None, split="test", download=True, annotation_file=None,
                  language="en", task='zeroshot_classification', **kwargs):
    """
    ...
    if dataset_name == "cifar10":
        ...
        if (language == 'multilingual_en'):
            # If we are loading the multilingual english version we override the annotation file
