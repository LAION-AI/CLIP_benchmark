# Adapted from https://github.com/mlfoundations/open_clip/blob/main/src/training/imagenet_zeroshot_data.py
# and  https://github.com/facebookresearch/SLIP/blob/main/labels.json
# Thanks to the authors of OpenCLIP and SLIP
zeroshot_templates = [
    "a bad photo of a {c}.",
    "a photo of many {c}.",
    "a sculpture of a {c}.",
